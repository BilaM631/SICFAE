...
def mega_migrate():
    sqlite_db_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'db_defc.sqlite3')
    ...
    models_to_migrate = [
        ...
        'core.Localidade', 'core.PerfilUtilizador', 'formacao.PlanoFormacao', 
        'formacao.Turma', 'formacao.SessaoFormacao', 'formacao.PresencaSessao'
    ]
    ...
    for model_label in models_to_migrate:
        ...
        if count > 0:
            ...
            # Use bulk_create in chunks of 100
    ...
    print("Mega Migration Finished for DEFC!", flush=True)
